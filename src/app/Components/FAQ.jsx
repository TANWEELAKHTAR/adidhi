...
const FAQ = () => {
  ...
  const jobseekersFAQ = [
    ...
    },
    {
      ...
      answer:
        " You can apply to jobs from a wide range of hospitality businesses like Hotels, Restaurants, Cafes, Resorts, Cloud Kitchens, and Catering businesses on Adidhi",
    },
    {
      question: "I have created my profile on the App. What's next?",
      answer:
        "That's awesome. Now, enter your preferences and relax as employers call you directly to discuss various opportunities",
    },
    {
      question: "I did not get OTP, what should I do?",
      answer:
        " If you do not get OTP, wait for some time and try again via the “Resend OTP” option. You will receive an SMS with your OTP. Enter that code to login or sign up.",
    },
    {
      question: "Do I have to pay to apply to jobs?",
      answer:
        "Absolutely not. This platform is 100% Free for all job applicants.",
    },
  ];
  ...
  const employersFAQ = [
    {
      ...
      answer:
        " In order to post a job, you need to register and fill out basic information about your business first. After that, you will be able to click on the “Post a Job” option wherein you need to enter details about the job like Job Title, Experience, Location, Job type, and so on.",
    },
    {
      question: "What kind of candidates can I find on Adidhi?",
      answer:
        " Right from skilled professionals and recent graduates to students willing to work part-time, you will find all kinds of candidates on Adidhi. You can choose applicants based on your requirement.",
    },
    {
      question: "How can I talk to candidates directly?",
      answer:
        "Once you have signed up and posted a job, you can see jobseekers profiles who have applied for the job. You can directly connect with them and discuss the job details.",
    },
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 mt-20">
      ...
      <div className="flex justify-center items-center mb-8 gap-4">
        ...
        <button
          onClick={() =>
            handleTabChange(
              activeTab === "jobseekers" ? "employers" : "jobseekers"
            )
          }
      ...
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold">
          Got Questions?{" "}
          <span className="text-[#DF6756]">We've Got Answers.</span>
        </h1>
      </div>
